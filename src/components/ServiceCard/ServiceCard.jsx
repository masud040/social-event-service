...
const ServiceCard = ({ service }) => {
  ...
  return (
    <div className="lg:w-96 mb-5 mx-auto rounded-md bg-gradient-to-r from-fuchsia-500 via-red-500 to-indigo-500 p-[3px] hover:scale-105 delay-100 transition-all">
